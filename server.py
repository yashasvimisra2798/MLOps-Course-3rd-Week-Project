...
GLOBAL_CONFIG = {
    "model": {
        ...
        "classifier": {
            "serialized_model_path": "/home/revanth/workspace/corise/week3/data/news_classifier.joblib"
        }
    },
    "service": {
        "log_destination": "/home/revanth/workspace/corise/week3/data/logs.out"
    }
}
...
class NewsCategoryClassifier:
    def __init__(self, config: dict) -> None:
        ...
        """
        sentence_transfomer = SentenceTransformer('sentence-transformers/{model}'.format(model=GLOBAL_CONFIG['model']['featurizer']["sentence_transformer_model"]))
    ...
    def predict_proba(self, model_input: dict) -> dict:
        ...
        """
        results = self.pipeline.predict_proba([model_input['description']]).flatten()
        classes = self.classes
        return dict(zip(classes, results))
